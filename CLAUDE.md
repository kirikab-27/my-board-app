...
- **Phase 0.5**: 観測基盤・モニタリング設定（Sentry・Analytics）🚧 計画済み
- **Phase 1**: NextAuth認証基盤・ユーザーモデル・bcrypt 🚧 計画済み
- **Phase 2**: メール認証・パスワードリセット・DKIM統合 🚧 計画済み
- **Phase 3**: 会員専用投稿機能・権限管理・匿名対応 🚧 計画済み
...
- **認証**: NextAuth.js + bcrypt + JWT（計画済み）
