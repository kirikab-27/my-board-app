...
export default function AuditLogsPage() {
  ...
  return (
    <AdminLayoutEnhanced title="監査ログ管理">
      <Box sx={{ p: 3 }}>
        {/* 統計カード */}
        ...
        <Paper sx={{ p: 2, mb: 3 }}>
          <Grid container spacing={2} alignItems="center">
            ...
            <Grid size={{ xs: 12, md: 2 }}>
              <Button fullWidth variant="contained" startIcon={<Search />} onClick={fetchLogs}>
                検索
              </Button>
            </Grid>
          </Grid>
          ...
          <Box sx={{ mt: 2, display: 'flex', gap: 2 }}>
            ...
            <Button variant="outlined" startIcon={<Archive />} onClick={handleArchive}>
              アーカイブ実行
            </Button>
          </Box>
        </Paper>
            ...
            <TableBody>
              {logs.map((log) => (
                <TableRow key={log._id}>
                  ...
                  <TableCell>
                    {log.signature ? <VerifiedUser color="primary" fontSize="small" /> : '-'}
                  </TableCell>
                  <TableCell>
                    <Tooltip title="詳細表示">
                      <IconButton
        ...
        <Dialog open={verifyDialog} onClose={() => setVerifyDialog(false)}>
          ...
          <DialogContent>
            <Typography>
              指定期間の監査ログチェーンを検証します。 改ざんがないことを確認できます。
            </Typography>
          </DialogContent>
          <DialogActions>
            ...
            {selectedLog && (
              <Box>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Typography variant="body2">IP: {selectedLog.ip}</Typography>
                </Box>
