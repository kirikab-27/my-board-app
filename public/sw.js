if (!self.define) {
  ...
  self.define = (i, c) => {
    ...
    s[t] = Promise.all(i.map((a) => u[a] || r(a))).then((a) => (c(...a), n));
  };
}
define(['./workbox-f52fd911'], function (a) {
  ...
  (importScripts(),
    ...
    a.precacheAndRoute(
      [
        { url: '/_next/app-build-manifest.json', revision: '479980bb3122e1195d39a9e6b035bd18' },
        { url: '/_next/dynamic-css-manifest.json', revision: 'd751713988987e9331980363e24189ce' },
        {
          url: '/_next/static/55MOnHh1K2Zk87txGIzjd/_buildManifest.js',
          revision: 'e11c20232243dae9b34ac2f66365e105',
        },
        {
          url: '/_next/static/55MOnHh1K2Zk87txGIzjd/_ssgManifest.js',
